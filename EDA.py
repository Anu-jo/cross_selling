...
sns.histplot(df[numeric_cols], kde=True, ax=axes[0])
axes[0].set_title('Distribution of Numeric Columns After Treatment')

sns.histplot(np.log1p(df[numeric_cols]), kde=True, ax=axes[1])
axes[1].set_title('Log-Transformed Distribution of Numeric Columns After Treatment')
...
axes[0].set_title('Boxplot of Numeric Columns After Treatment')

sns.boxplot(data=np.log1p(df[numeric_cols]), ax=axes[1])
axes[1].set_title('Boxplot of Log-Transformed Numeric Columns After Treatment')
...
numeric_df = df[numeric_cols]  # Only select numeric columns for correlation
